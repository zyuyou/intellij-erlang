...
final class Rebar3ProjectRootStep extends ProjectImportWizardStep {
  ...
  public Rebar3ProjectRootStep(WizardContext context) {
    super(context);
  ...
  public boolean validate() throws ConfigurationException {
    ...
    if (myGetDepsCheckbox.isSelected() && !ApplicationManager.getApplication().isUnitTestMode()) {
      ...
      if(!myRebarConfigurationForm.getPath().endsWith("rebar3")){
        return false;
      }
  ...
  @Override
  @NotNull
  protected Rebar3ProjectImportBuilder getBuilder() {
    return (Rebar3ProjectImportBuilder) super.getBuilder();
  }

  @NotNull
  private static String getRebarPath(@Nullable String directory) {
    if (directory != null) {
      File rebar3 = new File(directory, "rebar3");
      if (rebar3.exists() && rebar3.canExecute()) {
        return rebar3.getPath();
      }
    }
